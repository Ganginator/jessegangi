		...
		<?php
			...
			if(isset($_GET['pagename'])) {
				...
				switch($pagename) {
					...
					case 'about':
						echo ('<h1 class="title-page" style="text-align: center; margin-bottom: 30px;">Would You Like to Know More?</h1>');
					...
					default:
						echo ('<h1 class="title-page" style="text-align: center; margin-top: 100px;">Welcome!</h1>');
