			...
			<div class="navbar-inner">
				...
				<div id="fullnav" class="nav-collapse collapse" style=" text-align: center;">
					...
					<ul class="nav">
						...
						<li class="dropdown">
							<a href="?pagename=about" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-user icon-white"></i>&nbsp;&nbsp;About <b class="caret"></b>&nbsp; </a>
							<ul class="dropdown-menu">
								<li><a href="?pagename=about/experience"><i class="icon-road icon-black"></i>&nbsp;&nbsp;Experience&nbsp; </a></li>
								<li><a href="?pagename=about/portfolio"><i class="icon-briefcase icon-black"></i>&nbsp;&nbsp;Portfolio&nbsp; </a></li>
								<li><a href="?pagename=about/activities"><i class="icon-music icon-black"></i>&nbsp;&nbsp;Activities&nbsp; </a></li>
								<li><a href="?pagename=about/education"><i class="icon-book icon-black"></i>&nbsp;&nbsp;Education&nbsp; </a></li>
							</ul><!-- / .dropdown-menu -->
						</li><!-- / .dropdown -->
						<li class="dropdown">
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<a href="?pagename=tools" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-wrench icon-white"></i>&nbsp;&nbsp;Tools <b class="caret"></b>&nbsp; </a>
							<ul class="dropdown-menu">
								<li><a href="#" id="info" rel="clickover" class=""><i class="icon-info icon-black"></i>&nbsp;&nbsp;Info&nbsp;&nbsp;</a></li>
							</ul> --><!-- / .dropdown-menu --><!-- 
						</li> --><!-- / .dropdown -->
						<li><a href="?pagename=contact"><i class="icon-envelope-alt icon-white"></i>&nbsp;&nbsp;Contact&nbsp; </a></li>
						<li><a href="http://aerialapps.com/files/documents/resumes/resume_Jesse-Gangi_13-05-09.pdf" target="_blank"><i class="icon-download-alt icon-white"></i>&nbsp;&nbsp;One Sheet PDF</a></li>
					</ul><!-- / .nav .pull-right -->
